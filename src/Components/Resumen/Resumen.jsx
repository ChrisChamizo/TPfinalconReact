...
function Resumen(){
  return(
    <Box as="section" p="5" bg="gray.900" color="white" h="100vh">
        ...
        <Stack spacing="8" maxW="750px" mx="auto">
          <Box flexBasis="100%" textAlign="left" bg="gray.800" p="20px" borderRadius="md">
          ...
          <Stack direction="row" spacing="4" wrap="wrap" justify="center">
            ...
            bg="gray.800" p="20px" borderRadius="md" textAlign="left">
            ...
            <Box flexBasis={{ base: "100%", md: "45%" }} bg="gray.800" p="20px" borderRadius="md" textAlign="left">
